                ...
                <div class="intro-y box px-5 pt-5 mt-5">
                    ...
                    <ul class="nav nav-link-tabs flex-col sm:flex-row justify-center lg:justify-start text-center" role="tablist" >
                        ...
                        <li id="settings-tab" class="nav-item" role="presentation">
                            <a href="./update_profile.php" class="nav-link py-4 flex items-center" data-tw-target="#settings" aria-selected="false" role="tab" > <i class="w-4 h-4 mr-2" data-lucide="settings"></i> Settings </a>
                        </li>
                    </ul>
                </div>
                <!-- END: Profile Info -->
