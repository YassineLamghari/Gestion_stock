<nav class="side-nav">
                ...
                <ul>
                    ...
                    <li>
                        <a href="javascript:;" class="side-menu <?php if($page_menu == 'product_list' || $page_menu == 'add_product') {?> side-menu--active <?php } ?>">
                        ...
                        <ul class="<?php if($page_menu == 'product_list' || $page_menu == 'add_product') {?> side-menu--open side-menu__sub-open <?php } ?>">
                            <li>
                            ...
                            <li>
                                <a href="../product/add_product.php" class="side-menu<?php if($page_menu == 'add_product') {?> side-menu--active <?php } ?>">
                    ...
                    <li>
                        ...
                        <ul class="<?php if($page_menu == 'mon_profile' || $page_menu == 'change_password') {?> side-menu--open side-menu__sub-open <?php } ?>">
                            <li>
